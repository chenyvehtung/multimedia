...
class Ui_imgpro(object):
    def setupUi(self, imgpro):
        ...
        self.actionSave_Image = QtGui.QAction(imgpro)
    ...
    def retranslateUi(self, imgpro):
        ...
        self.labelWel.setText(_translate("imgpro", "Welcome to ImgPro", None))
        ...
        self.actionSave_Image.setText(_translate("imgpro", "Save Image", None))
        self.actionSave_Image.setShortcut(_translate("imgpro", "Ctrl+S", None))
